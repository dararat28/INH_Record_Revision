...
<body>
  ...
  <script>
    const baseURL = "https://script.google.com/macros/s/AKfycbxdCGjJxN-VliIHZ_4YehramGQkeVL1IBBxWLxQ_lNVU6Smz6IJr3n8qOJ6i9TUuSKm/exec"; // ใส่ URL ของ Apps Script ที่ deploy
