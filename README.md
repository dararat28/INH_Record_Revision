...
<body>
  ...
  <script>
    const baseURL = "https://script.google.com/macros/s/AKfycbwly6LQ2bSPLf-ogST9_3I34L-DtEPl-l-GdfyRKw7pWelmkc4rqWRpliDKsbPZPyr-/exec"; // ใส่ URL ของ Apps Script ที่ deploy
